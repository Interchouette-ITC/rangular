...
const REQUIRED_FIXTURES: &[&str] = &[
    ...
    "components/event-payload/event-payload.html",
    "components/event-payload/event-payload.scss",
    "components/io-parent/io-parent.html",
    "components/io-parent/io-parent.scss",
    "components/pipes/pipes.html",
    "components/pipes/pipes.scss",
    "components/two-way/two-way.html",
